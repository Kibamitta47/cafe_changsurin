...
<header class="header-menu" x-data="{ open:false }">
    <nav class="container mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-2">
            ...
            <a href="{{ route('user.dashboard') }}" class="px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('user.dashboard') ? 'bg-blue-500 text-white' : 'text-gray-700 hover:bg-gray-200' }}">หน้าบ้านของฉัน</a>
        ...
        <div class="flex items-center gap-3">
            ...
            <div x-data="{ openProfile:false }" class="relative">
                <button @click="openProfile=!openProfile"
                        class="flex items-center justify-center w-10 h-10 rounded-full focus:outline-none overflow-hidden border border-gray-300 hover:ring-2 hover:ring-blue-400">
