            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                                    ...
                                    <div class="mt-3 image-preview-container">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            @foreach($cafe->images as $imagePath)
                                                <img src="{{ asset('storage/' . $imagePath) }}" alt="Cafe Image" class="img-thumbnail" style="width:100px;height:100px;object-fit:cover;border-radius:.5rem;">
                                            @endforeach
                                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-block">
                            ...
                            <!-- Social Media -->
                            <div class="head-label" style="margin-top:10px"><span class="chip"></span><span>Social Media</span></div>
                            <div class="section-block">
                                <div class="mb-2">
                ...
                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('open_day') is-invalid @enderror" id="open_day" name="open_day">
                                        ...
                                        @foreach($days as $day)
                                            <option value="{{ $day }}" {{ old('open_day', $cafe->open_day ?? '') == $day ? 'selected' : '' }}>{{ $day }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('close_day') is-invalid @enderror" id="close_day" name="close_day">
                                        ...
                                        @foreach($closeDays as $day)
                                            <option value="{{ $day }}" {{ old('close_day', $cafe->close_day ?? '') == $day ? 'selected' : '' }}>{{ $day }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="form-section">
                        ...
                        <div class="section-block">
                            <div class="head-label" style="margin-top:6px"><span class="chip"></span><span>วิธีชำระเงิน</span></div>
                            ...
                            <div class="head-label" style="margin-top:8px"><span class="chip"></span><span>สิ่งอำนวยความสะดวก</span></div>
                            <div class="section-block mb-2 form-check-group d-flex flex-wrap">
                            ...
                            <div class="head-label" style="margin-top:8px"><span class="chip"></span><span>บริการเพิ่มเติม</span></div>
