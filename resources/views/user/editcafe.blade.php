...
<head>
    ...
    <style>
        ...
        .form-title .fa-coffee, .form-title .fa-edit {
            font-size: 1.8rem;
        }
        ...
        @media (max-width: 768px) {
            ...
            h5.section-header { padding: 0.75rem 1rem; margin: -1rem -1rem 1rem -1rem; }
        }
    </style>
</head>
<body>
                ...
                <div class="col-lg-6">
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- value จะดึงข้อมูลเดิมของ $cafe มาแสดง -->
                        ...
                        <div class="mb-3">
                            ...
                            <!-- ส่วนนี้จะแสดงผลเฉพาะหน้าแก้ไข เพื่อโชว์รูปภาพที่มีอยู่ -->
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="url" name="website" class="form-control @error('website') is-invalid @enderror" placeholder="https://www.yourcafe.com"
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="facebook_page" class="form-control @error('facebook_page') is-invalid @enderror" placeholder="ลิงก์ Facebook Page"
                        ...
                        <div class="mb-3">
                             <div class="input-group">
                                ...
                                <input type="text" name="instagram_page" class="form-control @error('instagram_page') is-invalid @enderror" placeholder="ชื่อผู้ใช้ Instagram"
                        ...
                        <div class="mb-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="line_id" class="form-control @error('line_id') is-invalid @enderror" placeholder="Line ID หรือ @บัญชี"
                     ...
                     <div class="form-section">
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="lat" name="lat" class="form-control @error('lat') is-invalid @enderror" placeholder="จากแผนที่" required
                                    value="{{ old('lat', $cafe->lat ?? '') }}" />
                                @error('lat')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-sm-6">
                                <label for="lng" class="form-label">ลองจิจูด</label>
                                <input type="text" id="lng" name="lng" class="form-control @error('lng') is-invalid @enderror" placeholder="จากแผนที่" required
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const map = L.map('map').setView(mueangSurinCenter, 12); 
        ...
        // ดึงค่า lat/lng เริ่มต้นมาปักหมุด
        ...
        map.on('click', function(e) {
            ...
            if (mueangSurinBounds.contains(e.latlng)) {
                ...
                alert('ตำแหน่งที่เลือกอยู่นอกเขตอำเภอเมืองสุรินทร์');
                displayOutOfBoundsWarning(true);
            }
        });
        ...
        async function checkCoordinates(lat, lng) {
            ...
            // ส่ง ID ของคาเฟ่ที่กำลังแก้ไขไปด้วย เพื่อไม่ให้เช็คซ้ำกับตัวเอง
            const cafeId = "{{ $cafe->id ?? 'null' }}"; 
            try {
                // โปรดตรวจสอบว่า route นี้ถูกต้องและมีอยู่จริง
                ...
                const isDuplicate = data.exists ?? data.is_duplicate; // รองรับทั้งสอง key
                duplicateCoordsWarning.classList.toggle('d-none', !isDuplicate);
                
                if (isDuplicate || !mueangSurinBounds.contains([lat, lng])) {
                    submitBtn.disabled = true;
                } else {
                    submitBtn.disabled = false;
                }
                ...
                submitBtn.disabled = false; // กรณีเกิด error, อนุญาตให้กดได้ก่อน
            }
        }
    });
</script>
