...
<head>
    ...
    <style>
        ...
        .form-title{color:var(--primary-dark);font-weight:700;text-align:center;margin-bottom:1.25rem;padding-bottom:.75rem;border-bottom:2px solid var(--border-color);display:flex;align-items:center;justify-content:center;gap:.75rem}
        ...
        .map-toolbar{display:flex;gap:.5rem;flex-wrap:wrap;margin:.5rem 0}
        #map{height:380px;border-radius:var(--radius);border:1px solid var(--border-color);margin-bottom:1rem}
        @media (max-width:768px){ .form-container{padding:1rem} #map{height:300px} .actions .btn{flex:1} }
    </style>
</head>
<body>
<div class="container">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const locateBtn = document.getElementById('locateBtn'); // ปุ่ม "ปักหมุดที่ฉันอยู่"
    ...
    // ปุ่มรีเซ็ต (แก้แล้ว — มีใน DOM และไม่ทำให้สคริปต์พัง)
    ...
    // พิมพ์พิกัดแล้วให้แผนที่ขยับตาม
