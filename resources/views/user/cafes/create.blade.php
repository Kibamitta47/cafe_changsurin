...
<head>
    ...
    <title>เพิ่มข้อมูลคาเฟ่ใหม่</title>
    ...
    <style>
        ...
        body {
            ...
            background-color: #f4f7f9; /* Lighter, cooler background */
        ...
        h5.section-header {
            color: var(--primary-dark);
            font-weight: 600;
            margin: -1.5rem -1.5rem 1.5rem -1.5rem; /* Extend to edges of the section */
            padding: 1rem 1.5rem;
                         ...
                         <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('open_day') is-invalid @enderror" id="open_day" name="open_day">
                                    ...
                                    @foreach($days as $day)<option value="{{ $day }}" {{ (isset($cafe) && $cafe->open_day == $day) || old('open_day') == $day ? 'selected' : '' }}>{{ $day }}</option>@endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('close_day') is-invalid @enderror" id="close_day" name="close_day">
                                    ...
                                    @foreach($closeDays as $day)<option value="{{ $day }}" {{ (isset($cafe) && $cafe->close_day == $day) || old('close_day') == $day ? 'selected' : '' }}>{{ $day }}</option>@endforeach
                                </select>
                                 @error('close_day')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                        <!-- TIME INPUTS AS REQUESTED -->
                        <div class="row mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function checkCoordinates(lat, lng) {
            ...
            try {
                ...
                submitBtn.disabled = data.exists || !mueangSurinBounds.contains([lat, lng]);
            } catch (error) {
