...
<head>
 ...
 <style>
    ...
    .container.mt-5.mb-5,
    .container { background:#fff; border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,.05); padding:40px; }
    ...
    /* ===== หัวข้อแบบภาพแนบ (สี่เหลี่ยมฟ้า + ข้อความเข้ม) ===== */
    .head-label{
      display:flex; align-items:center; gap:8px;
      margin:14px 0 8px;
      font-size:16px; line-height:1.25;
      font-weight:800; color:#1f3b65; letter-spacing:.1px;
    }
    .head-label .chip{
      width:12px; height:12px; border-radius:2px;
      background:#3b82f6; box-shadow:0 .5px 0 rgba(0,0,0,.06);
      flex:0 0 12px;
    }
    .section-block{
      padding:10px 0 2px;
...
<div class="container">
  ...
  <div class="form-container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <!-- ที่ตั้ง -->
        <div class="head-label"><span class="chip"></span><span>ที่ตั้ง</span></div>
        <div class="section-block">
          <div class="mb-3">
        ...
        <div class="section-block">
          ...
          <div class="section-block mb-2 d-flex flex-wrap gap-2">
          ...
          <div class="section-block d-flex flex-wrap gap-2">
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function compressImage(file, {maxDim=1600, targetBytes=1.5*1024*1024} = {}) {
    ...
    theSize = fitContain(bitmap.width, bitmap.height, maxDim);
    const canvas = document.createElement('canvas');
    canvas.width = theSize.width; canvas.height = theSize.height;
    const ctx = canvas.getContext('2d');
    ctx.drawImage(bitmap, 0, 0, theSize.width, theSize.height);
