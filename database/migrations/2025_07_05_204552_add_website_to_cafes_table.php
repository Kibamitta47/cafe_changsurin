...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('cafes', function (Blueprint $table) {
            // เนื่องจากคอลัมน์ 'website' ถูกเพิ่มใน migration 'create_cafes_table' แล้ว
            // เราจึงไม่จำเป็นต้องเพิ่มมันอีกครั้งที่นี่
            // หากคุณต้องการเพิ่มคอลัมน์อื่น ๆ ในภายหลัง สามารถเพิ่มที่นี่ได้
            // ตัวอย่าง: $table->string('new_website_related_column')->nullable();
        });
    }
    ...
    public function down(): void
    {
        Schema::table('cafes', function (Blueprint $table) {
            ...
            // ตัวอย่าง: $table->dropColumn('new_website_related_column');
        });
    }
};
